...
export default class UnityContent {
  ...
  public send(
    ...
    if (this.unityInstance != null) {
      ...
      } else if (typeof parameter2 === "undefined") {
        this.unityInstance.SendMessage(gameObjectName, methodName, parameter1);
      } else {
        this.unityInstance.SendMessage(gameObjectName, methodName, parameter1, parameter2);
      }
    }
  }
  ...
  public on(eventName: string, eventCallback: Function): any {
    ...
    (window as any).ReactUnityWebGL[eventName] = (parameter1: any, parameter2?: any) => {
      if (typeof(parameter2) === "undefined")
        return eventCallback(parameter1);
      else 
        return eventCallback(parameter1, parameter2);
    };
  }
